        ...
        <div className="container-flex">
          ...
          <div className="row row-spacing">
            ...
            <div className="col-md-6 text-column">
              ...
              <h3 className="subtitle">Nipping early orthodontic problems in the bud</h3>
              <p clasName="paragraph">Adolescence is hard enough. When a teen feels self-conscious about crooked teeth, overbite or underbite, he or she may avoid smiling, become withdrawn, and miss out on social activities. The truth is, crooked teeth, overbite or underbite can have profound effects on a teenager’s self-esteem. That’s where Anne O’Day Orthodontics can help. Dr. O’Day offers a full spectrum of orthodontic solutions to straighten teeth, including Invisalign for teens. And since she is a mom herself, she will treat your teen with the compassion and respect they need to feel good about the orthodontic process, from start to finish!</p>
            </div>
          </div>
